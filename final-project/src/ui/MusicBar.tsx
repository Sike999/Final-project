    ...
    return (
        <div className="items-center h-[75px] rounded-[70px] bg-[#00000063] fixed bottom-0 left-8 right-8 z-50 mb-[16px] px-[40px] flex justify-between">
            <div className="flex gap-[10px]">
                <TbPlayerSkipBack size={30} color="white" className="clickableSize30"/>
                {isPlaying ? <PiPause size={30} color="white" className="clickableSize30"/> : <IoPlayOutline size={30} color="white" className="clickableSize30"/>}
                <TbPlayerSkipForward size={30} color="white" className="clickableSize30"/>
            </div>
            <div className="flex gap-[10px]">
            ...
            <div className="flex gap-[10px]">
                {isLiked ? < IoIosHeart size={30} color="#92CC0D" className="clickableSize30"/> : <IoIosHeartEmpty size={30} color="white" className="clickableSize30"/>}
                <VscDebugRestart size={30} color="white" className="clickableSize30"/>
                <TfiControlShuffle size={30} color="white" className="clickableSize30"/>
                <GoShareAndroid size={30} color="white" className="clickableSize30"/>
            </div>
        </div>
    )
}